...
CONFIG=${CONFIG:-configs/experiments/remote100_two_stage_adaptive_mig_five_512.yaml}
...
method=two_stage_adaptive_blocks_mig
...
"$GUARDBENCH_PYTHON" scripts/compute_remote100_partial_metrics.py \
    ...
    --methods \
        ...
        two_stage_adaptive_blocks_mig \
    --output-dir \
        runs/remote100_four_methods_512_20260723/evaluation/adaptive_mig_single_vs_two_stage_common_five \
    --device cuda
