...
CONFIG=${CONFIG:-configs/experiments/remote100_single_stage_mig_inpaint_five_512.yaml}
...
method=single_stage_mig_inpaint_g8
...
"$GUARDBENCH_PYTHON" scripts/compute_remote100_partial_metrics.py \
    ...
    --methods \
        clean \
        mig_inpaint_g8 \
        single_stage_mig_inpaint_g8 \
        single_stage_adaptive_blocks_mig \
    --output-dir \
        runs/remote100_four_methods_512_20260723/evaluation/single_stage_mig_common_five \
    --device cuda
