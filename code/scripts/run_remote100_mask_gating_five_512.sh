...
for sample in "${samples[@]}"; do
    for method in mask_jacobian_gating mask_correlation_gating; do
...
"$GUARDBENCH_PYTHON" scripts/compute_remote100_partial_metrics.py \
    ...
    --methods \
        ...
        mask_jacobian_gating \
        mask_correlation_gating \
    --output-dir \
        runs/remote100_four_methods_512_20260723/evaluation/mask_gating_common_five \
    --device cuda
